      ...
      if (mod.indexOf("visual-") === 0 || mod === "minecraft-textures" || mod === "advanced-mods") {
        if (mod === "advanced-mods") {
          ...
          function syncAdvanced(){
            if(advBtn) advBtn.textContent = "Open";
            card.classList.remove("matrix-visual-on");
          ...
          if(advBtn && card.dataset.advancedWired !== "1"){
            ...
            advBtn.addEventListener("click", function(){
              if (window.__matrixAdvancedMods && window.__matrixAdvancedMods.open) {
                window.__matrixAdvancedMods.open();
              }
            });
          }
          if(advOpt) advOpt.addEventListener("click", function(){ if(window.__matrixAdvancedMods && window.__matrixAdvancedMods.open) window.__matrixAdvancedMods.open(); });
          return;
        }
